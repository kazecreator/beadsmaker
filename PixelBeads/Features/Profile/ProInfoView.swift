...
struct ProInfoView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(L10n.tr("PixelBeads Pro"))
    ...
    private var heroSection: some View {
        VStack(spacing: 16) {
            ZStack {
                Circle()
                    .fill(PixelBeadsTheme.ink.opacity(0.06))
            ...
            VStack(spacing: 16) {
                ...
                VStack(spacing: 6) {
                    Text(L10n.tr("You're a Pro Creator"))
                        .font(.title2.bold())
                        .foregroundStyle(PixelBeadsTheme.ink)
                    Text(L10n.tr("Thank you for supporting PixelBeads. You have unlimited drafts, iCloud sync, and full access to every feature."))
                        .font(.subheadline)
                        .foregroundStyle(.secondary)
